...
def login():
	...
	if user==usera and password==pas:
		pass
	else:
		print("xalata")
		time.sleep(3)
...
\x1b[0m
       ...
       [+] Instagram : \033[0;31mj7krd\033[0;37m
       [+] Snapchat  : \033[0;31mahmadhemn67
\033[0;37m""")
print('[+] 1- Auto All Report ')
print('[+] 2- Choose Report \n')
a5tar = input('\033[1;36m[+] Choose ==> : \x1b[0m')
if a5tar == '1':
    time.sleep(1)
    print('''
[+] Orginal Report 
...
''')
    ...
    time.sleep(1)
    print("")
    id1 = input('\033[1;36m[+] User Target ==> : \x1b[0m')
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req1:
            ...
            print('\033[0;31m[-] Faild Report Orginal')
        time.sleep(3)
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req2:
            ...
            print('\033[0;31m[-] Faild Report Hate Speech')
        time.sleep(3)
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req3:
            print('[+] Report Suicide, Self Has Been sent')
        else:
            print('\033[0;31m[-] Faild Report Suicide, Self')
if a5tar == '2':
    print('''
[+] 1- Orginal Report 
[+] 2- Report Hate Speech 
[+] 3- Suicide, Self Report 
''')
a5tar2 = input('\033[1;36m[+] Choose ==> : \x1b[0m')
if a5tar2 == '1':
    username = input('\033[1;36m[+] User Target ==> : \x1b[0m')
    url4 = f'https://www.tiktok.com/@{username}?'
    req4 = requests.get(url4).text
    ref2 = re.findall('"pageId":"(.*?)"', req4)
    ref4 = "".join(ref2)
    url5 = f'https://www.tiktok.com/node/report/reasons_put?aid=1988&app_name=tiktok_web&device_platform=web&referer=https:%2F%2Fwww.tiktok.com%2Flogout%3Fredirect_url%3Dhttps%253A%252F%252Fwww.tiktok.com%252F%2540{username}%253Flang%253Dar%2526is_copy_url%253D1%2526is_from_webapp%253Dv1%26lang%3Dar&root_referer=https:%2F%2Fwww.google.com%2F&user_agent=Mozilla%2F5.0+(Windows+NT+10.0%3B+Win64%3B+x64)+AppleWebKit%2F537.36+(KHTML,+like+Gecko)+Chrome%2F88.0.4324.150+Safari%2F537.36&cookie_enabled=true&screen_width=1366&screen_height=768&browser_language=ar&browser_platform=Win32&browser_name=Mozilla&browser_version=5.0+(Windows+NT+10.0%3B+Win64%3B+x64)+AppleWebKit%2F537.36+(KHTML,+like+Gecko)+Chrome%2F88.0.4324.150+Safari%2F537.36&browser_online=true&ac=3g&timezone_name=Asia%2FRiyadh&page_referer=https:%2F%2Fwww.tiktok.com%2F%3Flang%3Dar&priority_region=&verifyFp=verify_kktawy8t_4JksVm1Z_b02R_4OZw_8Xow_ltbTSgi07rs4&appId=1233&region=SA&appType=m&isAndroid=false&isMobile=false&isIOS=false&OS=windows&did=6926024599109109250'
    headers5 = {
    'accept': 'application/json, text/plain, */*',
    'accept-encoding': 'gzip, deflate, br',
    'accept-language': 'ar,en-US;q=0.9,en;q=0.8',
    ...
    'cookie': 'tt_webid_v2=6926024599109109250; tt_webid=6926024599109109250; s_v_web_id=verify_kktawy8t_4JksVm1Z_b02R_4OZw_8Xow_ltbTSgi07rs4; ttwid=1%7CuU0ZIsyDyN3VZI2n8WRgeKbCOnBi7rzo0O5ubfexN7c%7C1612590836%7C1c5cb49ee5e8f958b35190103ce1ea37891a648dc344853098c36dd9d798f52b; passport_csrf_token=abd11d0de6008199789a3435e8e75597; passport_csrf_token_default=abd11d0de6008199789a3435e8e75597; store-idc=alisg; store-country-code=sa; passport_auth_status=0a5f55489be7d62253f3cc65c0176ba7%2C; passport_auth_status_ss=0a5f55489be7d62253f3cc65c0176ba7%2C; tt_csrf_token=3H0AVQGcx3wrGM9Ct5CM86g8; bm_sz=CEDD94E411A442C0D8E8E4DB52B38D15~YAAQlV4zVqiAhxl3AQAAxXWqjArR9DTcYUvyaCSG9u+t7aVTy7HuDoYx8ajcmmNYUnwVb0ofH6T45tb9rcEchG+dZ4pafmNiEuCgKDh0ryEQnEyo0PmCAosf+kaD7eKlDjPVXIxQUXf+QsOTAfcADI7+LVaBsHrfiMGjZC/yYdGdPc3B1IeIjgQ46A3C6u/G; ak_bmsc=C95264048DEF32C5F485D597CDDA107556335E95983C0000AD0224609B6F3619~; csrf_session_id=fdc677247e844960a04f30d6d0b0a0fd; MONITOR_WEB_ID=6926024599109109250; _abck=D86CAAA87344DFBC4EA1879ADDCFE240~0~~-1~||-1||~-1; odin_tt=79ba0c090463658d4e00cea7ef9d83836810b0b60877fec0060cefae0a0bc7548b6391b7cdff121053c133136653b22d7f34a3a4f8fbbc1c746a72e99258b380dd070278f0ec3519a5a8162c48369a69; sid_guard=e1e9772b7f3ee4d7de9f5142d6dd8028%7C1612975986%7C21600%7CWed%2C+10-Feb-2021+22%3A53%3A06+GMT; uid_tt=e7564b699b2f412e7d98038a067e6c89; uid_tt_ss=e7564b699b2f412e7d98038a067e6c89; sid_tt=e1e9772b7f3ee4d7de9f5142d6dd8028; sessionid=e1e9772b7f3ee4d7de9f5142d6dd8028; sessionid_ss=e1e9772b7f3ee4d7de9f5142d6dd8028; bm_sv=BE8DC204511096FF25C1C4C74525246F~JFcUOsKuslhtsbwJCHYiRHmC8qSngmagSpzdnLsxA7i3mO40Rit2u/Azu7dWJMzPwWSXSApVM4M6YQ2ET26E8N7ggWII9nohsu/p8tiLh60p8c6NlUXJiJnjuMM2x7hGZYVze8qLe9UUMDSsGon7ZV9HBDojB1TR7d/IJAjByzY=',
    'origin': 'https://www.tiktok.com',
    'referer': f'https://www.tiktok.com/@{username}?lang=ar&is_copy_url=1&is_from_webapp=v1',
    'sec-fetch-dest': 'empty',
    'sec-fetch-mode': 'cors',
    'sec-fetch-site': 'same-origin',
    'tt-csrf-token': '3H0AVQGcx3wrGM9Ct5CM86g8',
    ...
    time.sleep(3)
    while True:
        req5 = requests.post(url5, json=data5, headers=headers5).text
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req5:
            print('\033[1;32m[+] Report Has Been Sent')
        else:
            print('\033[0;31m[-] Faild Report')
if a5tar2 == '2':
    username2 = input('\033[1;36m[+] User Target ==> : \x1b[0m')
    url6 = f'https://www.tiktok.com/@{username2}?'
    req0 = requests.get(url6).text
    ref5 = re.findall('"pageId":"(.*?)"', req0)
    ref6 = "".join(ref5)
    url7 = f'https://www.tiktok.com/node/report/reasons_put?aid=1988&app_name=tiktok_web&device_platform=web&referer=https:%2F%2Fwww.tiktok.com%2Flogout%3Fredirect_url%3Dhttps%253A%252F%252Fwww.tiktok.com%252F%2540{username2}%253Flang%253Dar%2526is_copy_url%253D1%2526is_from_webapp%253Dv1%26lang%3Dar&root_referer=https:%2F%2Fwww.google.com%2F&user_agent=Mozilla%2F5.0+(Windows+NT+10.0%3B+Win64%3B+x64)+AppleWebKit%2F537.36+(KHTML,+like+Gecko)+Chrome%2F88.0.4324.150+Safari%2F537.36&cookie_enabled=true&screen_width=1366&screen_height=768&browser_language=ar&browser_platform=Win32&browser_name=Mozilla&browser_version=5.0+(Windows+NT+10.0%3B+Win64%3B+x64)+AppleWebKit%2F537.36+(KHTML,+like+Gecko)+Chrome%2F88.0.4324.150+Safari%2F537.36&browser_online=true&ac=4g&timezone_name=Asia%2FRiyadh&page_referer=https:%2F%2Fwww.tiktok.com%2F%3Flang%3Dar&priority_region=&verifyFp=verify_kktawy8t_4JksVm1Z_b02R_4OZw_8Xow_ltbTSgi07rs4&appId=1233&region=SA&appType=m&isAndroid=false&isMobile=false&isIOS=false&OS=windows&did=6926024599109109250'
    headers6 = {
    'accept': 'application/json, text/plain, */*',
    'accept-encoding': 'gzip, deflate, br',
    'accept-language': 'ar,en-US;q=0.9,en;q=0.8',
    ...
    'cookie': 'tt_webid_v2=6926024599109109250; tt_webid=6926024599109109250; s_v_web_id=verify_kktawy8t_4JksVm1Z_b02R_4OZw_8Xow_ltbTSgi07rs4; ttwid=1%7CuU0ZIsyDyN3VZI2n8WRgeKbCOnBi7rzo0O5ubfexN7c%7C1612590836%7C1c5cb49ee5e8f958b35190103ce1ea37891a648dc344853098c36dd9d798f52b; passport_csrf_token=abd11d0de6008199789a3435e8e75597; passport_csrf_token_default=abd11d0de6008199789a3435e8e75597; store-idc=alisg; store-country-code=sa; passport_auth_status=0a5f55489be7d62253f3cc65c0176ba7%2C; passport_auth_status_ss=0a5f55489be7d62253f3cc65c0176ba7%2C; tt_csrf_token=3H0AVQGcx3wrGM9Ct5CM86g8; bm_sz=CEDD94E411A442C0D8E8E4DB52B38D15~YAAQlV4zVqiAhxl3AQAAxXWqjArR9DTcYUvyaCSG9u+t7aVTy7HuDoYx8ajcmmNYUnwVb0ofH6T45tb9rcEchG+dZ4pafmNiEuCgKDh0ryEQnEyo0PmCAosf+kaD7eKlDjPVXIxQUXf+QsOTAfcADI7+LVaBsHrfiMGjZC/yYdGdPc3B1IeIjgQ46A3C6u/G; ak_bmsc=C95264048DEF32C5F485D597CDDA107556335E95983C0000AD0224609B6F3619~; csrf_session_id=fdc677247e844960a04f30d6d0b0a0fd; MONITOR_WEB_ID=6926024599109109250; odin_tt=79ba0c090463658d4e00cea7ef9d83836810b0b60877fec0060cefae0a0bc7548b6391b7cdff121053c133136653b22d7f34a3a4f8fbbc1c746a72e99258b380dd070278f0ec3519a5a8162c48369a69; sid_guard=e1e9772b7f3ee4d7de9f5142d6dd8028%7C1612975986%7C21600%7CWed%2C+10-Feb-2021+22%3A53%3A06+GMT; uid_tt=e7564b699b2f412e7d98038a067e6c89; uid_tt_ss=e7564b699b2f412e7d98038a067e6c89; sid_tt=e1e9772b7f3ee4d7de9f5142d6dd8028; sessionid=e1e9772b7f3ee4d7de9f5142d6dd8028; sessionid_ss=e1e9772b7f3ee4d7de9f5142d6dd8028; bm_sv=BE8DC204511096FF25C1C4C74525246F~JFcUOsKuslhtsbwJCHYiRHmC8qSngmagSpzdnLsxA7i3mO40Rit2u/Azu7dWJMzPwWSXSApVM4M6YQ2ET26E8N7ggWII9nohsu/p8tiLh61QrCoHj5w/gSzZaNy1d6/WU2+Om/yOSP/tA/LXIq2ZmZId6brtxawDlJMtVZuKMW0=; _abck=D86CAAA87344DFBC4EA1879ADDCFE240~0~~-1~-1~-1',
    'origin': 'https://www.tiktok.com',
    'referer': f'https://www.tiktok.com/@{username2}?lang=ar&is_copy_url=1&is_from_webapp=v1',
    'sec-fetch-dest': 'empty',
    'sec-fetch-mode': 'cors',
    'sec-fetch-site': 'same-origin',
    'tt-csrf-token': '3H0AVQGcx3wrGM9Ct5CM86g8',
    ...
    time.sleep(3)
    while True:
        req6 = requests.post(url7, json=data6, headers=headers6).text
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req6:
            print('\033[1;32m[+] Report Has Been Sent')
        else:
            print('\033[0;31m[-] Faild Report')
if a5tar2 == '3':
    username3 = input('\033[1;36m[+] User Target ==> : \x1b[0m')
    url00 = f'https://www.tiktok.com/@{username3}?'
    req00 = requests.get(url00).text
    ref50 = re.findall('"pageId":"(.*?)"', req00)
    ref60 = "".join(ref50)
    url30 = f'https://www.tiktok.com/node/report/reasons_put?aid=1988&app_name=tiktok_web&device_platform=web&referer=https:%2F%2Fwww.tiktok.com%2Flogout%3Fredirect_url%3Dhttps%253A%252F%252Fwww.tiktok.com%252F%2540{username3}%253Flang%253Dar%2526is_copy_url%253D1%2526is_from_webapp%253Dv1%26lang%3Dar&root_referer=https:%2F%2Fwww.google.com%2F&user_agent=Mozilla%2F5.0+(Windows+NT+10.0%3B+Win64%3B+x64)+AppleWebKit%2F537.36+(KHTML,+like+Gecko)+Chrome%2F88.0.4324.150+Safari%2F537.36&cookie_enabled=true&screen_width=1366&screen_height=768&browser_language=ar&browser_platform=Win32&browser_name=Mozilla&browser_version=5.0+(Windows+NT+10.0%3B+Win64%3B+x64)+AppleWebKit%2F537.36+(KHTML,+like+Gecko)+Chrome%2F88.0.4324.150+Safari%2F537.36&browser_online=true&ac=4g&timezone_name=Asia%2FRiyadh&page_referer=https:%2F%2Fwww.tiktok.com%2F%3Flang%3Dar&priority_region=&verifyFp=verify_kktawy8t_4JksVm1Z_b02R_4OZw_8Xow_ltbTSgi07rs4&appId=1233&region=SA&appType=m&isAndroid=false&isMobile=false&isIOS=false&OS=windows&did=6926024599109109250'
    headers30 = {
    'accept': 'application/json, text/plain, */*',
    'accept-encoding': 'gzip, deflate, br',
    'accept-language': 'ar,en-US;q=0.9,en;q=0.8',
    ...
    'cookie': 'tt_webid_v2=6926024599109109250; tt_webid=6926024599109109250; s_v_web_id=verify_kktawy8t_4JksVm1Z_b02R_4OZw_8Xow_ltbTSgi07rs4; ttwid=1%7CuU0ZIsyDyN3VZI2n8WRgeKbCOnBi7rzo0O5ubfexN7c%7C1612590836%7C1c5cb49ee5e8f958b35190103ce1ea37891a648dc344853098c36dd9d798f52b; passport_csrf_token=abd11d0de6008199789a3435e8e75597; passport_csrf_token_default=abd11d0de6008199789a3435e8e75597; store-idc=alisg; store-country-code=sa; passport_auth_status=0a5f55489be7d62253f3cc65c0176ba7%2C; passport_auth_status_ss=0a5f55489be7d62253f3cc65c0176ba7%2C; tt_csrf_token=3H0AVQGcx3wrGM9Ct5CM86g8; bm_sz=CEDD94E411A442C0D8E8E4DB52B38D15~YAAQlV4zVqiAhxl3AQAAxXWqjArR9DTcYUvyaCSG9u+t7aVTy7HuDoYx8ajcmmNYUnwVb0ofH6T45tb9rcEchG+dZ4pafmNiEuCgKDh0ryEQnEyo0PmCAosf+kaD7eKlDjPVXIxQUXf+QsOTAfcADI7+LVaBsHrfiMGjZC/yYdGdPc3B1IeIjgQ46A3C6u/G; ak_bmsc=C95264048DEF32C5F485D597CDDA107556335E95983C0000AD0224609B6F3619~; csrf_session_id=fdc677247e844960a04f30d6d0b0a0fd; MONITOR_WEB_ID=6926024599109109250; odin_tt=79ba0c090463658d4e00cea7ef9d83836810b0b60877fec0060cefae0a0bc7548b6391b7cdff121053c133136653b22d7f34a3a4f8fbbc1c746a72e99258b380dd070278f0ec3519a5a8162c48369a69; sid_guard=e1e9772b7f3ee4d7de9f5142d6dd8028%7C1612975986%7C21600%7CWed%2C+10-Feb-2021+22%3A53%3A06+GMT; uid_tt=e7564b699b2f412e7d98038a067e6c89; uid_tt_ss=e7564b699b2f412e7d98038a067e6c89; sid_tt=e1e9772b7f3ee4d7de9f5142d6dd8028; sessionid=e1e9772b7f3ee4d7de9f5142d6dd8028; sessionid_ss=e1e9772b7f3ee4d7de9f5142d6dd8028; _abck=D86CAAA87344DFBC4EA1879ADDCFE240~0~~-1~-1~-1; bm_sv=BE8DC204511096FF25C1C4C74525246F~JFcUOsKuslhtsbwJCHYiRHmC8qSngmagSpzdnLsxA7i3mO40Rit2u/Azu7dWJMzPwWSXSApVM4M6YQ2ET26E8N7ggWII9nohsu/p8tiLh63FOdDR93DRy/7eK+6Q9eE6lML02i620733Uf7aOjwkcE8u3Ftj/XPTm7x6xt5Mlvg=',
    'origin': 'https://www.tiktok.com',
    'referer': f'https://www.tiktok.com/@{username3}?lang=ar&is_copy_url=1&is_from_webapp=v1',
    'sec-fetch-dest': 'empty',
    'sec-fetch-mode': 'cors',
    'sec-fetch-site': 'same-origin',
    'tt-csrf-token': '3H0AVQGcx3wrGM9Ct5CM86g8',
